...
var products = function products(datas) {
  ...
  flagImg.src = "".concat(datas.ülkebayrağı);
  card.append(flagImg);
  ...
  ulkeP.textContent = "".concat(datas.ülke, " (").concat(datas.ülkeKodu, ")");
  cardInfo.append(ulkeP);
  var enlemBoylamP = document.createElement('p');
  enlemBoylamP.textContent = "Enlem: ".concat(datas.enlem, " Boylam: ").concat(datas.boylam);
  cardInfo.append(enlemBoylamP);
  var sehirP = document.createElement('p');
  sehirP.textContent = "\u015Eehir: ".concat(datas.şehir);
  cardInfo.append(sehirP);
  var saatDilimiP = document.createElement('p');
  saatDilimiP.textContent = "Saat Dilimi: ".concat(datas.saatdilimi);
  cardInfo.append(saatDilimiP);
  var paraBirimiP = document.createElement('p');
  paraBirimiP.textContent = "Para Birimi: ".concat(datas.parabirimi);
  cardInfo.append(paraBirimiP);
  var ispP = document.createElement('p');
  ispP.textContent = "ISP: ".concat(datas.isp);
  cardInfo.append(ispP);
  card.append(cardInfo);
  var cardsContainer = document.querySelector('.cards');
  cardsContainer.append(card);
};
_axios.default.get('https://apis.ergineer.com/ipgeoapi/188.119.5.39').then(function (response) {
